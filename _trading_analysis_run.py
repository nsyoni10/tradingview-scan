...
symbols = ['SAN','NSC','MOD','UDR','AM','ABVX','BRX','PSO','FR','LTH','MSM','NATL','AKR','CALY','DRH','PUMP','SEM','NVGS','NVRI','OLPX','FLTCF','RIOFF','VGZ','ALXO','ARRNF','MJNA','QEDN']
results = analyze(symbols)

print()
header = f"{'SYMBOL':<8} {'PRICE':>8} {'CHG%':>7} {'RSI':>6} {'VOL%':>7} {'REC':<14} {'SENTIMENT':<10} {'SMA20':>8} {'SMA50':>8}"
print(header)
print('-' * 90)
for r in results:
    sym = r['symbol']
    ...
    sma20 = r['sma20']
    sma50 = r['sma50']
    print(f"{sym:<8} {price:>8.2f} {chg:>7.2f} {rsi:>6.1f} {vol:>7.1f} {rec:<14} {sent:<10} {sma20:>8.2f} {sma50:>8.2f}")
