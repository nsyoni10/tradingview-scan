...
symbols = 'SAN,NSC,MOD,UDR,AM,ABVX,BRX,PSO,FR,LTH,MSM,NATL,AKR,CALY,DRH,PUMP,SEM,NVGS,NVRI,OLPX,FLTCF,RIOFF,VGZ,ALXO,ARRNF,MJNA,QEDN'.split(',')
results = analyze(symbols)
with open('_trading_analysis_long.json', 'w') as f:
    json.dump(results, f, indent=2)
print(f'Saved {len(results)} results to _trading_analysis_long.json')
